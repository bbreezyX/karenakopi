  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row min-h-screen relative z-10">
        <div className="w-full md:w-1/2 text-foreground p-8 md:p-24 flex flex-col justify-center">
          <motion.div
        ...
        <div className="w-full md:w-1/2 px-4 md:px-0">
          <div className="relative overflow-hidden h-[60vh] md:min-h-[80vh] group rounded-[3rem] md:rounded-[4rem] border border-foreground/10">
            ...
            >
              <div className="bg-background/80 backdrop-blur-xl border border-foreground/10 p-5 md:p-10 max-w-[280px] md:max-w-sm rounded-[1.5rem] md:rounded-[2.5rem]">
