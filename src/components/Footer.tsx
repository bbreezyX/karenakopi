...
export const Footer = () => {
  return (
    <footer className="bg-foreground text-background py-24 md:py-32 px-6 md:px-12 relative z-20 overflow-hidden rounded-t-[5rem] md:rounded-t-[10rem]">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-end gap-16 md:gap-24">
        ...
        <div className="space-y-8 md:space-y-12">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            {/* Location 1: JBC */}
            <div className="text-background/60 text-[11px] md:text-xs space-y-1.5 uppercase tracking-[0.2em] font-bold">
              <p className="text-accent underline decoration-accent/30 underline-offset-4">
                01 — JBC
              </p>
              <p className="text-background/80 font-black">
                Jambi Business Center
              </p>
              <p className="text-background/60">
                Jl. Kapt A. Bakaruddin, Jambi
              </p>
              <a
                href="https://www.google.com/maps/search/?api=1&query=Jambi Business Center"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-block pt-2 text-accent hover:text-background transition-colors font-black"
              >
                Directions →
              </a>
            </div>
            ...
            <div className="text-background/60 text-[11px] md:text-xs space-y-1.5 uppercase tracking-[0.2em] font-bold">
              ...
              <p className="text-background/60">No.E5, Sungai Putri, Jambi</p>
              <a
          ...
          <div className="pt-4">
            <p className="text-background text-sm md:text-base uppercase tracking-[0.2em] font-black bg-accent/20 px-6 py-2 rounded-full w-fit">
        ...
        <div className="flex flex-col items-start md:items-end gap-8 w-full md:w-auto">
          <div className="flex gap-8">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-background/40 hover:text-accent text-2xl transition-all duration-300 transform hover:scale-110"
          ...
          <div className="text-[10px] uppercase tracking-[0.3em] text-background/40 font-black text-left md:text-right space-y-1">
